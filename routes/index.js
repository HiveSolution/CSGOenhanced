var gameSchema = require("../utils/gameDataSchema");
var Ajv = require("ajv");
 ...
 * @param {Function} callback Function to be executed after it's done.
 * @returns gameData Object filled with default values,
 */
function dataProcess (gameData, callback) {
  // var renderData = {
  //   "map": {
  ...
  //   }
  // }
  var validate = ajv.compile(gameSchema);
